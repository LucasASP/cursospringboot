...
public class CategoriaResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody CategoriaDTO objDto) { //@RequestBody faz com que o objeto Json seja convertido para java automaticamente
		//@Valid faz com que o objeto CategoriaDTO seja validado antes de seguir pra frente -  é utilizado da validações na classe CategoriaDTO
